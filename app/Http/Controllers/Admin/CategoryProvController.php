...
use App\src\Repositories\CategoryProvRepository;
...
class CategoryProvController extends Controller
{
    private $categoryRepository;
    private $subCategoryRepository;
    private $productSubCategoryRepository;

    public function __construct(CategoryProvRepository $categoryRepository,
    ...
    public function index()
    {
        ...
        return view('admin.pages.category_proveedor.index')->with([
    ...
    {
        $category = Category_prov::find($id);
    ...
    public function updateInTable(CategoryUpdateRequest $request)
    {
        ...
        try {
            ...
            $repo = new CategoryProvRepository($product);
    ...
    public function buscarSubCategorias($category_id){

        return DB::table('category_proveedor')
            ->join('sub_category', 'category_proveedor.id', '=', 'sub_category.category_id')
            ->select('sub_category.id', 'sub_category.name')->where('sub_category.category_id',$category_id)
