...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/fonts/iconss.css') }}">
    ...
    <script src="//widget.manychat.com/1156281887857960.js" async="async"></script>
...
<div id="container_cart_floating_fox_fixed">
    <div class="cart-floating-box-fixed cart-floating-box-remove" id="cart-floating-box-fixed">
        @include('web.layouts._cart_floating_box_fixed')
    </div>
</div>

<div class="social">
        <ul>
            <li><a href="https://www.facebook.com/delivery.mimercado/" target="_blank" class="icon-facebook2"></a></li>
            <li><a href="https://www.instagram.com/mimercadodelivery/" target="_blank" class="icon-instagram"></a></li>
            <li><a href="https://api.whatsapp.com/send?phone=51948313098&text=%20" target="_blank" class="icon-whatsapp"></a></li>
            <li><a href="https://www.linkedin.com/company/mimercado-delivery/" target="_blank" class="icon-linkedin"></a></li>
        </ul>
</div>
<!-- scroll to top  -->
<a href="javascript:void(0)" class="scroll-cart" id="open_cart_popup">
    <img src="{{ asset('assets/images/shop.png') }}" style="width: 100%; height: 100%;">
</a>
