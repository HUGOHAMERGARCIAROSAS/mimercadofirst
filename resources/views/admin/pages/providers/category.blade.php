...
@slot('header_title')Categorias del Proveedor: <strong>{{$proveedor->razon_social}}</strong> @endslot
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('categories_desde_prov.store') }}" method="post" enctype="multipart/form-data">
                    {{  csrf_field() }}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input id="proveedor_id" type="hidden" class="form-control"
                                   name="proveedor_id" value="{{$proveedor->id}}"
                                   >
                        </div>
                        <div class="form-group">
                            <label>Imagen </label>
