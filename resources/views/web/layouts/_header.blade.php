<header><meta http-equiv="Content-Type" content="text/html; charset=shift_jis">
    <!--=======  header top  =======-->
    <div class="header-top pt-10 pb-10 pt-lg-11 pb-lg-10 pt-md-10 pb-md-10">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-4 col-sm-6 col-xs-12 text-center text-sm-left text-lg-right">
                        ...
                        <ul>
                            <li>
                                <img src="{{ asset('assets\images\icon-phone.png') }}" class="img-fluid"
                                     alt="{{ __('web.name') }}" style="height: 24px;">
                                Delivery <a href="https://api.whatsapp.com/send?phone=51948313098&text=%20"><span class="number font-weight-500">{{ __('web.phone') }}</span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- end of currncy language dropdown -->
                </div>
                <div class="col-lg-7 col-md-8 col-sm-6 col-xs-12  text-center text-sm-right">
                    <!-- header top menu -->
                    <div class="header-top-menu">
                        <ul>
                            <li><a href="{{ route('web.tips.index') }}">TIPS Y RECETAS</a></li>
                            <li><a href="{{ route('web.recipes.index') }}">PROMOCIONES</a></li>
                            <li><a href="{{ route('web.storeImage.index') }}">VENTAS MAYORISTAS</a></li>
                            <li><a href="{{ route('web.contact.index') }}">CONTÁCTENOS</a></li>
                        </ul>
                    </div>
    ...
    <div class="header-bottom header-bottom-other header-sticky">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12 text-lg-left text-md-center text-sm-center sticky-logo-scroll">
                    <!-- logo -->
                    <div class="logo">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('assets/frutasencasa/logo.png') }}" class="img-fluid" alt="logo">
                        </a>
                    </div>
                    <!-- end of logo -->
                </div>
                <div class="col-md-9 col-sm-12 col-xs-12 stick-menu-scroll">
                    <div class="menubar-top d-flex justify-content-between align-items-center flex-sm-wrap flex-md-wrap flex-lg-nowrap mt-sm-15">
                        ...
                        <!-- end of search bar -->
                        <div class="header-contact d-flex phone_account_web">
                            <div class="phone-number font-weight-500">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li class="menu-item-has-children menu-nav">
                                    ...
                                    <ul class="mega-menu three-column row" style="overflow-y: auto; height: 470px">
                                ...
                                <li class="menu-item-has-children menu-nav">
                                    <a href="{{ route('web.search.productsInCategory', ['slugCategory' => \App\src\Models\Category::$CATEGORY_SLUG_BABYS]) }}">Babys
                                        - Kids</a>
                                    <ul class="mega-menu three-column row">
                                ...
                                <li class="menu-item-has-children menu-nav">
                                    <a href="{{ route('web.search.productsInCategory', ['slugCategory' => \App\src\Models\Category::$CATEGORY_SLUG_CUIDADDO_PERSONAL]) }}">Cuidado
                                        Personal</a>
                                    <ul class="mega-menu three-column row">
                                ...
                                <li class="menu-item-has-children menu-nav">
                                    <a href="{{ route('web.search.productsInCategory', ['slugCategory' => \App\src\Models\Category::$CATEGORY_SLUG_BEBIDAS_LICORES]) }}">Bebidas
                                        y Licores</a>
                                    <ul class="mega-menu three-column row">
