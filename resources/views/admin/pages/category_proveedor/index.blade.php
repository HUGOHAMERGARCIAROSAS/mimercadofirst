...
@section('block-header')
    @component('admin.components.block-header')
        @slot('header_title')Categorias @endslot
...
@section('content')
    <div class="col-md-12">
        ...
        <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#exampleModal2">
            <i class="fa fa-plus-square"></i> Nueva Sub Categoría
        </button>
                ...
                <div class="table-responsive">
                    @component('admin.components.content_datatable')
                        ...
                        @slot('datatable_body')
                            ...
                            @include('admin.pages.category_proveedor._tbody_categories')
                            </tbody>
                        @endslot
                    @endcomponent
                </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('categories_prov.store') }}" method="post" enctype="multipart/form-data">
                    {{  csrf_field() }}
...
@section('scripts')
    ...
    <script>
        ...
        function searchCategory(categoryId) {
            ...
            $.ajax({
                url: "{{ route('admin.category_prov.search') }}",
                method: 'POST',
                dataType: "JSON",
                data: data,
            }).done((response) => {
        ...
        function searchSubCategory(subCategoryId) {
            ...
            $.ajax({
                url: "{{ route('admin.category_prov.searchSubCategories') }}",
                method: 'POST',
                dataType: "JSON",
                data: data,
            }).done((response) => {
