        ...
        <div class="col-lg-5 col-md-8 col-sm-12">
            <h2>
                <a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth">
                    <i class="fa fa-arrow-left"></i></a> Proveedor: <strong>{{$usuarios->razon_social}}</strong>
                    <?php $xd = $usuarios->id;  ?>
            </h2>
        </div>
        <div class="col-lg-7 col-md-4 col-sm-12 text-right">
            <a href="{{ route('products_provider.create',$xd) }}" class="btn btn-primary btn-lg ml-15">
                <i class="fa fa-plus-square"></i> Nuevo Producto
            </a>
            <a href="{{ route('products_provider.category.ver', $xd) }}" class="btn btn-info btn-lg ml-15">
          ...
          <!--  <a href="{{ route('admin.product.updateCategory') }}" class="btn btn-warning btn-lg ml-15">
            ...
            title="Exportar en Excel">
             <i class="fa fa-file-excel-o"></i>Exportar Categorias (excel)
         </a>
        ...
        <div class="modal-content">
            ...
            <form action="{{route('import-excel',$id )}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="provider_id" value="{{$id}}" class="form-control" required>
                    </div>
                </div>
...
<script>
    ...
    $(function () {
        ...
        $('#basic-datatable-products').DataTable({
            ...
            serverSide: true,
            "ordering": true,
            ajax: '{{ route('admin.product.listProducts.prov',$xd) }}',
            'columnDefs': [{
