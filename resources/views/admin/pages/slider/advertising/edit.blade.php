    ...
    <div class="col-md-12">
        <div class="card">
            <div class="body">
                ...
                <form method="POST" action="{{ route('advertising.update', $sliderAdvertising) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
